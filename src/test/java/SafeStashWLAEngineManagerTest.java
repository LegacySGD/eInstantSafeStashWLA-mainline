...
public class SafeStashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SafeStashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SafeStashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SafeStashWLAIW/InitOutcome.xml").getDocumentElement();
